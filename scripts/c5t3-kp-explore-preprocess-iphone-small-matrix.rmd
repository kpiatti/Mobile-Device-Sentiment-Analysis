...
```{r}
#create confusion matrix for training subset predictions
confusionMatrix(data = rf_fit01_training,
                reference = iphone_df_train$iphonesentiment)
```
```{r}
...
```{r}
#create confusion matrix for cross validated predictions
confusionMatrix(data = rf_fit01.1_cv,
                reference = iphone_df_train$iphonesentiment)
```
